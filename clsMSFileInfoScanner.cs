...
#Region "Classwide Variables"
    ...
    Public Event MessageEvent(Message As String) Implements iMSFileInfoScanner.MessageEvent
    Public Event ErrorEvent(Message As String) Implements iMSFileInfoScanner.ErrorEvent
...
#Region "Processing Options and Interface Functions"
    ...
    Public Function GetDataFileFilename(eDataFileType As iMSFileInfoScanner.eDataFileTypeConstants) As String Implements iMSFileInfoScanner.GetDataFileFilename
    ...
    Public Sub SetDataFileFilename(strFilePath As String, eDataFileType As iMSFileInfoScanner.eDataFileTypeConstants) Implements iMSFileInfoScanner.SetDataFileFilename
        Select Case eDataFileType
            Case iMSFileInfoScanner.eDataFileTypeConstants.MSFileInfo
    ...
    Public Shared ReadOnly Property DefaultDataFileName(eDataFileType As iMSFileInfoScanner.eDataFileTypeConstants) As String
        Get
...
#End Region
    ...
    Private Sub AddToStringList(ByRef strList() As String, strNewEntry As String, ByRef intListCount As Integer)
    ...
    Private Sub CheckIntegrityOfFilesInFolder(
       strFolderPath As String,
       blnForceRecheck As Boolean,
        ...
        Try
            ...
            If intFileCount > 0 Then
                ...
                If blnCheckFolder Then
                    ...
                    mFileIntegrityChecker.CheckIntegrityOfFilesInFolder(strFolderPath, udtFolderStats, udtFileStats, strProcessedFileList)
    ...
    Private Function GetFileOrFolderInfo(strFileOrFolderPath As String, ByRef blnIsFolder As Boolean, ByRef objFileSystemInfo As FileSystemInfo) As Boolean
    ...
    Private Sub LoadCachedResults(blnForceLoad As Boolean)
        If mUseCacheFiles Then
    ...
    Public Function LoadParameterFileSettings(strParameterFilePath As String) As Boolean Implements iMSFileInfoScanner.LoadParameterFileSettings
    ...
    Protected Sub OpenFileIntegrityOutputFile(eDataFileType As iMSFileInfoScanner.eDataFileTypeConstants, ByRef strFilePath As String, ByRef objStreamWriter As StreamWriter)
    ...
    ''' <returns>True if success; false if failure</returns>
    Public Function PostDatasetInfoToDB(strDatasetInfoXML As String) As Boolean Implements iMSFileInfoScanner.PostDatasetInfoToDB
    ...
    ''' <returns>True if success; false if failure</returns>
    Public Function PostDatasetInfoToDB(strConnectionString As String, strStoredProcedure As String) As Boolean Implements iMSFileInfoScanner.PostDatasetInfoToDB
    ...
    ''' <param name="strStoredProcedure">Stored procedure</param>
    ''' <returns>True if success; false if failure</returns>
    Public Function PostDatasetInfoToDB(
       strDatasetInfoXML As String,
       strConnectionString As String,
       strStoredProcedure As String) As Boolean Implements iMSFileInfoScanner.PostDatasetInfoToDB
    ...
    ''' <param name="strStoredProcedure">Stored procedure</param>
    ''' <returns>True if success; false if failure</returns>
    Public Function PostDatasetInfoUseDatasetID(
       intDatasetID As Integer,
       strConnectionString As String,
       strStoredProcedure As String) As Boolean Implements iMSFileInfoScanner.PostDatasetInfoUseDatasetID
    ...
    Private Function ProcessMSDataset(
       strInputFileOrFolderPath As String,
      ByRef objMSInfoScanner As iMSFileInfoProcessor,
        ...
        Do
            ...
            If Not blnSuccess Then
                ...
                If intRetryCount < MAX_FILE_READ_ACCESS_ATTEMPTS Then
                    ...
                    If DateTime.Now.Subtract(udtFileInfo.FileSystemCreationTime).TotalMinutes < FILE_MODIFICATION_WINDOW_MINUTES OrElse
    ...
    Public Function ProcessMSFileOrFolder(
       strInputFileOrFolderPath As String,
       strOutputFolderPath As String) As Boolean Implements iMSFileInfoScanner.ProcessMSFileOrFolder
    ...
    Public Function ProcessMSFileOrFolderWildcard(strInputFileOrFolderPath As String, strOutputFolderPath As String, blnResetErrorCode As Boolean) As Boolean Implements iMSFileInfoScanner.ProcessMSFileOrFolderWildcard
        ...
        Try
            ...
            If Not strInputFileOrFolderPath Is Nothing AndAlso (strInputFileOrFolderPath.IndexOf("*"c) >= 0 Or strInputFileOrFolderPath.IndexOf("?"c) >= 0) Then
                ...
                For Each fiFileMatch In diFolderInfo.GetFiles(strInputFileOrFolderPath)
                    ...
                    If eMSFileProcessingState = iMSFileInfoScanner.eMSFileProcessingStateConstants.ProcessedSuccessfully OrElse
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function ProcessMSFilesAndRecurseFolders(
       strInputFilePathOrFolder As String,
       strOutputFolderPath As String,
       intRecurseFoldersMaxLevels As Integer) As Boolean Implements iMSFileInfoScanner.ProcessMSFilesAndRecurseFolders
        ...
        Try
            If Not strInputFilePathOrFolder Is Nothing AndAlso
               (strInputFilePathOrFolder.IndexOf("*"c) >= 0 Or strInputFilePathOrFolder.IndexOf("?"c) >= 0) Then
                ' Copy the path into strCleanPath and replace any * or ? characters with _
    ...
    Private Function RecurseFoldersWork(
       ...
       strFileNameMatch As String,
       strOutputFolderPath As String,
      ByRef intFileProcessCount As Integer,
      ByRef intFileProcessFailCount As Integer,
       intRecursionLevel As Integer,
    ...
    Public Function SaveCachedResults(blnClearCachedData As Boolean) As Boolean Implements iMSFileInfoScanner.SaveCachedResults
        If mUseCacheFiles Then
    ...
    Public Function SaveParameterFileSettings(strParameterFilePath As String) As Boolean Implements iMSFileInfoScanner.SaveParameterFileSettings
    ...
    Private Sub SetErrorCode(eNewErrorCode As iMSFileInfoScanner.eMSFileScannerErrorCodes)
        SetErrorCode(eNewErrorCode, False)
    End Sub

    Private Sub SetErrorCode(eNewErrorCode As iMSFileInfoScanner.eMSFileScannerErrorCodes, blnLeaveExistingErrorCodeUnchanged As Boolean)
    ...
    Protected Sub ShowMessage(strMessage As String, eMessageType As eMessageTypeConstants)
    ...
    Protected Sub ShowMessage(strMessage As String, blnAllowLogToFile As Boolean, blnPrecedeWithNewline As Boolean, eMessageType As eMessageTypeConstants)
    ...
    Public Shared Function ValidateDataFilePath(ByRef strFilePath As String, eDataFileType As iMSFileInfoScanner.eDataFileTypeConstants) As Boolean
    ...
    Private Shared Function ValidateDataFilePathCheckDir(strFilePath As String) As Boolean
    ...
    Private Sub WriteFileIntegrityDetails(ByRef srOutFile As StreamWriter, intFolderID As Integer, udtFileStats() As clsFileIntegrityChecker.udtFileStatsType)
        ...
        For intIndex = 0 To udtFileStats.Length - 1
            With udtFileStats(intIndex)
                ...
                srOutFile.WriteLine(intFolderID.ToString & ControlChars.Tab &
                  .FileName & ControlChars.Tab &
                  .SizeBytes.ToString & ControlChars.Tab &
                  .ModificationDate.ToString("yyyy-MM-dd HH:mm:ss") & ControlChars.Tab &
                  .FailIntegrity & ControlChars.Tab &
                  .FileHash & ControlChars.Tab &
    ...
    Private Sub WriteFileIntegrityFailure(ByRef srOutFile As StreamWriter, strFilePath As String, strMessage As String)
        Static dtLastWriteTime As DateTime

        If srOutFile Is Nothing Then Exit Sub

        ' Note: HH:mm:ss corresponds to time in 24 hour format
        srOutFile.WriteLine(strFilePath & ControlChars.Tab &
          strMessage & ControlChars.Tab &
    ...
    Private Sub mFileIntegrityChecker_ErrorCaught(strMessage As String) Handles mFileIntegrityChecker.ErrorCaught
        ShowErrorMessage("Error caught in FileIntegrityChecker: " & strMessage)
    End Sub

    Private Sub mFileIntegrityChecker_FileIntegrityFailure(strFilePath As String, strMessage As String) Handles mFileIntegrityChecker.FileIntegrityFailure
    ...
    Private Sub mMSInfoScanner_ErrorEvent(Message As String) Handles mMSInfoScanner.ErrorEvent
        ShowErrorMessage(Message)
    End Sub

    Private Sub mMSInfoScannerMessageEvent(Message As String) Handles mMSInfoScanner.MessageEvent
        ShowMessage(Message, eMessageTypeConstants.Normal)
    End Sub

    Private Sub mMSFileInfoDataCache_ErrorEvent(Message As String) Handles mMSFileInfoDataCache.ErrorEvent
        ShowErrorMessage(Message)
    End Sub

    Private Sub mMSFileInfoDataCache_StatusEvent(Message As String) Handles mMSFileInfoDataCache.StatusEvent
        ShowMessage(Message)
    End Sub

    Private Sub mExecuteSP_DBErrorEvent(Message As String) Handles mExecuteSP.DBErrorEvent
        ShowErrorMessage(Message)
    End Sub
