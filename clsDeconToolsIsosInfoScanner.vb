...
Public Class clsDeconToolsIsosInfoScanner
	...
	Private Function GetScanOrFrameColIndex(ByVal lstData As List(Of String), ByVal strFileDescription As String) As Integer
	...
	Private Sub LoadData(ByVal fiIsosFile As FileInfo, ByRef udtFileInfo As iMSFileInfoProcessor.udtFileInfoType)
	...
	Private Function LoadIsosFile(ByVal strIsosFilePath As String, ByVal sngMaxFit As Single) As List(Of udtIsosDataType)
	...
	Private Function LoadScansFile(ByVal strScansFilePath As String) As List(Of udtScansDataType)
	...
	Private Sub ParseColumnHeaders(ByVal dctColumnInfo As Dictionary(Of String, Integer), ByVal lstData As List(Of String), ByVal strFileDescription As String)
