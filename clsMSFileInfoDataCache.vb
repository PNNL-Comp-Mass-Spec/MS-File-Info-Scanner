...
#End Region
    ...
    Public Function ConstructHeaderLine(ByVal eDataFileType As clsMSFileInfoScanner.eDataFileTypeConstants) As String
        Select Case eDataFileType
            Case clsMSFileInfoScanner.eDataFileTypeConstants.MSFileInfo
            ...
            Case clsMSFileInfoScanner.eDataFileTypeConstants.FolderIntegrityInfo
            ...
            Case clsMSFileInfoScanner.eDataFileTypeConstants.FileIntegrityDetails
            ...
            Case clsMSFileInfoScanner.eDataFileTypeConstants.FileIntegrityErrors
    ...
    Public Sub InitializeVariables()
        ...
        Me.AcquisitionTimeFilePath = System.IO.Path.Combine(clsMSFileInfoScanner.GetAppFolderPath(), clsMSFileInfoScanner.DefaultDataFileName(clsMSFileInfoScanner.eDataFileTypeConstants.MSFileInfo))
        clsMSFileInfoScanner.ValidateDataFilePath(Me.AcquisitionTimeFilePath, clsMSFileInfoScanner.eDataFileTypeConstants.MSFileInfo)
           ...
           mFolderIntegrityInfoResultsState = eCachedResultsStateConstants.Modified Then
            ...
            Try
                ...
                Else
                    ...
                    srOutFile.WriteLine(ConstructHeaderLine(clsMSFileInfoScanner.eDataFileTypeConstants.FolderIntegrityInfo))
           ...
           mMSFileInfoCachedResultsState = eCachedResultsStateConstants.Modified Then
            ...
            Try
                ...
                Else
                    ...
                    srOutFile.WriteLine(ConstructHeaderLine(clsMSFileInfoScanner.eDataFileTypeConstants.MSFileInfo))
    ...
    Public Function UpdateCachedMSFileInfo(ByVal udtFileInfo As MSFileInfoScanner.iMSFileInfoProcessor.udtFileInfoType) As Boolean
