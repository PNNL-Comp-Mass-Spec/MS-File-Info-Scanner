rem AgilentGCDFolderInfoScanner.cs
...
rem AgilentIonTrapDFolderInfoScanner.cs
...
rem AgilentOrQStarWiffFileInfoScanner.cs  (uses clsProteowizardDataParser)
...
rem AgilentTOFDFolderInfoScanner.cs  (uses clsProteowizardDataParser)
...
rem BrukerOneFolderInfoScanner.cs
...
rem BrukerXmassFolderInfoScanner.cs
...
..\bin\MSFileInfoScanner.exe TestData\15T\2015_08_16_MeOH_Blank_1_01_3924.d\analysis.baf                        /python /SS /DI /2D /CC /O:TestData_Results\BrukerXmassBAF\15T
..\bin\MSFileInfoScanner.exe \\proto-11\15T_FTICR_Imaging\2016_3\20160729_DV_3D_pos\20160729_DV_3D_pos_03to38.d /python /SS /DI /2D /CC /O:TestData_Results\BrukerXmassBAF\15T_Imaging

rem DeconToolsIsosInfoScanner.cs
...
rem FinniganRawFileInfoScanner.cs
...
..\bin\MSFileInfoScanner.exe TestData\Astral\QC_Shew_23_02_10ng_R01_Dragonfly_05Mar26_ES903_4947_48SPD.raw         /python /SS /DI /2D /CC /O:TestData_Results\Thermo\Astral
..\bin\MSFileInfoScanner.exe TestData\AstralZoom\CompRef_TMT16_500ng_HR_30SPD_R1_AZ_Evosep02_13Oct25_EV1137.raw    /python /SS /DI /2D /CC /O:TestData_Results\Thermo\AstralZoom
..\bin\MSFileInfoScanner.exe TestData\Eclipse\QC_Mam_19_01_c_Samwise_26July21_WBEH-21-01-24.raw                    /python /SS /DI /2D /CC /O:TestData_Results\Thermo\Eclipse
..\bin\MSFileInfoScanner.exe TestData\Exploris\QC_Mam_23_01_r2_15Mar26_Bart_BEH-CoA-25-08-09.raw                   /python /SS /DI /2D /CC /O:TestData_Results\Thermo\Exploris

..\bin\MSFileInfoScanner.exe TestData\Thermo_with_LC\20200207_Fusion2_Dionex_BSA_OTOT-08_20200211162337.raw         /python /SS /DI /2D /CC /O:TestData_Results\Thermo\Thermo_with_LC\20200207_Fusion2_Dionex_BSA_OTOT-08
..\bin\MSFileInfoScanner.exe TestData\Thermo_with_LC\20200210_HF_BSA_04.raw                                         /python /SS /DI /2D /CC /O:TestData_Results\Thermo\Thermo_with_LC\20200210_HF_BSA_04
...
rem Thermo mzML:
..\bin\MSFileInfoScanner.exe TestData\Thermo\QC_Shew_18_02_Excerpt.mzML                                    /python /SS /DI /2D /CC /O:TestData_Results\Thermo\ThermoQExactive_mzML

rem MicromassRawFolderInfoScanner.cs
...
rem ZippedImagingFilesScanner.cs
..\bin\MSFileInfoScanner.exe TestData\20120510_grid /python /ms2mzmin:113 /SS /DI /2D /CC /O:TestData_Results\R00X

rem AgilentMassHunterDFolderInfoScanner.cs
..\bin\MSFileInfoScanner.exe TestData\AgQTOF\RMB_190208_hcarb_R1R5_5.d /python /SS /DI /2D /CC /O:TestData_Results\AgQTOF\RMB_190208_hcarb_R1R5_5
rem Incomplete dataset: ..\bin\MSFileInfoScanner.exe TestData\XG_03Jan12_stdT1.d               /python /SS /DI /2D /CC /O:TestData_Results\AgQTOF\XG_03Jan12_stdT1
