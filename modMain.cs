    ...
    static class modMain
    {
        ...
        private static void ShowProgramHelp()
        {
            try {
                ...
                Console.WriteLine((string)("Use /M to define the maximum number of lines to process when checking text or csv files; default is /M:" + clsFileIntegrityChecker.DEFAULT_MAXIMUM_TEXT_FILE_LINES_TO_CHECK.ToString));
                Console.WriteLine();
