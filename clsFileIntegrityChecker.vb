...
#Region "Constants and Enums"
	...
	Public Const AGILENT_TOF_OR_QTRAP_FILE_EXTENSION As String = ".WIFF"
...
#Region "Classwide Variables"
    ...
    Public Event ErrorCaught(strMessage As String)
    Public Event FileIntegrityFailure(strFilePath As String, strMessage As String)
...
#End Region
    ...
    ''' <remarks></remarks>
    Protected Function CheckTextFile(strFilePath As String) As Boolean
    ...
    ''' </summary>
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckTextFileWork(strFilePath As String, intMinimumLineCount As Integer, intMinimumTabCount As Integer) As Boolean
    ...
    ''' </summary>
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckTextFileWork(strFilePath As String, intMinimumLineCount As Integer, intMinimumTabCount As Integer, blnRequireEqualTabsPerLine As Boolean) As Boolean
    ...
    ''' </summary>
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckTextFileWork(strFilePath As String, intMinimumLineCount As Integer, intMinimumTabCount As Integer, blnRequireEqualTabsPerLine As Boolean, blnCharCountSkipsBlankLines As Boolean) As Boolean
    ...
    ''' </summary>
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckTextFileWork(strFilePath As String, intMinimumLineCount As Integer, intMinimumTabCount As Integer, strRequiredTextLineHeader As String, blnRequireEqualTabsPerLine As Boolean) As Boolean
    ...
    ''' </summary>
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckTextFileWork(strFilePath As String, intMinimumLineCount As Integer, intMinimumTabCount As Integer, strRequiredTextLineHeader As String, blnRequireEqualTabsPerLine As Boolean, blnRequiredTextMatchesLineStart As Boolean) As Boolean
    ...
    ''' </summary>
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckTextFileWork(strFilePath As String, intMinimumLineCount As Integer, intMinimumTabCount As Integer, strRequiredTextLineHeaders() As String, blnRequireEqualTabsPerLine As Boolean) As Boolean
    ...
    ''' </summary>
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckTextFileWork(strFilePath As String, intMinimumLineCount As Integer, intMinimumTabCount As Integer, strRequiredTextLineHeaders() As String, blnRequireEqualTabsPerLine As Boolean, blnRequiredTextMatchesLineStart As Boolean, intRequiredTextMinMatchCount As Integer) As Boolean
    ...
    ''' </summary>
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckTextFileWork(strFilePath As String, intMinimumLineCount As Integer, intMinimumTabCount As Integer, intMinimumCommaCount As Integer) As Boolean
    ...
    ''' </summary>
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckTextFileWork(strFilePath As String, intMinimumLineCount As Integer, intMinimumTabCount As Integer, intMinimumCommaCount As Integer, blnRequireEqualTabsPerLine As Boolean, blnRequireEqualCommasPerLine As Boolean) As Boolean
    ...
    ''' </summary>
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckTextFileWork(strFilePath As String, intMinimumLineCount As Integer, strRequiredTextLineHeader As String, blnRequiredTextMatchesLineStart As Boolean) As Boolean
    ...
    ''' </summary>
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckTextFileWork(strFilePath As String, intMinimumLineCount As Integer, strRequiredTextLineHeaders() As String, blnRequiredTextMatchesLineStart As Boolean) As Boolean
    ...
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    ''' <remarks></remarks>
    Protected Function CheckTextFileWork(
       strFilePath As String,
       intMinimumLineCount As Integer,
       intMinimumTabCount As Integer,
       intMinimumCommaCount As Integer,
       blnRequireEqualTabsPerLine As Boolean,
       blnRequireEqualCommasPerLine As Boolean,
       strRequiredTextLineHeaders() As String,
       blnRequiredTextMatchesLineStart As Boolean,
       blnCharCountSkipsBlankLines As Boolean,
       intRequiredTextMinMatchCount As Integer) As Boolean
    ...
    ''' <remarks></remarks>
    Protected Function CheckTextFileCountChars(
     ByRef strLineIn As String,
     ByRef blnBlankLineRead As Boolean,
      intLinesRead As Integer,
     ByRef intExpectedCharCount As Integer,
      chCharToCount As Char,
      strCharDescription As String,
      intMinimumCharCount As Integer,
      blnRequireEqualCharsPerLine As Boolean,
    ...
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    ''' <remarks></remarks>
    Protected Function CheckExtensionFreeFile(strFilePath As String) As Boolean
        Dim blnLineIsValid As Boolean = True
    ...
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    ''' <remarks></remarks>
    Protected Function CheckParamsFile(strFilePath As String) As Boolean
    ...
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    ''' <remarks></remarks>
    Protected Function CheckTICFile(strFilePath As String) As Boolean
    ...
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    ''' <remarks></remarks>
    Protected Function CheckZIPFile(strFilePath As String) As Boolean
    ...
    Private Function CheckZipFileIntegrity(strZipFilePath As String, blnCheckAllData As Boolean, blnThrowExceptionIfInvalid As Boolean) As Boolean
    ...
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    ''' <remarks></remarks>
    Protected Function CheckCSVFile(strFilePath As String) As Boolean
    ...
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckXMLFile(strFilePath As String) As Boolean
    ...
    ''' </summary>
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    Protected Function CheckXMLFileWork(strFilePath As String, intMinimumElementCount As Integer) As Boolean
    ...
    ''' <returns>True if the file passes the integrity check; otherwise False</returns>
    ''' <remarks></remarks>
    Protected Function CheckXMLFileWork(
       strFilePath As String,
       intMinimumElementCount As Integer,
       strRequiredElementNames() As String,
       strRequiredAttributeNames() As String) As Boolean
    ...
    Public Function CheckIntegrityOfFilesInFolder(
       strFolderPath As String,
      ByRef udtFolderStats As udtFolderStatsType,
      ByRef udtFileStats() As udtFileStatsType,
    ...
    Protected Function CountChars(strText As String, chSearchChar As Char) As Integer
    ...
    ''' <remarks></remarks>
    Protected Sub FindRequiredTextInLine(
      ByRef strLineToSearch As String,
      ByRef blnNeedToCheckRequiredText As Boolean,
      ByRef strRequiredText() As String,
      ByRef blnRequiredTextFound() As Boolean,
      ByRef intRequiredTextMatchCount As Integer,
       blnMatchStart As Boolean)
    ...
    ''' <remarks></remarks>
    Protected Function FileIsDecon2LSXMLSettingsFile(strFilePath As String) As Boolean
    ...
    ''' <remarks></remarks>
    Protected Function FileIsXMLSettingsFile(strFilePath As String) As Boolean
    ...
    ''' <remarks></remarks>
    Protected Function XMLFileContainsElements(strFilePath As String, strElementsToMatch() As String) As Boolean
    ...
    ''' <returns>True if this file contains the required element text</returns>
    ''' <remarks></remarks>
    Protected Function XMLFileContainsElements(strFilePath As String, strElementsToMatch() As String, intMaximumTextFileLinesToCheck As Integer) As Boolean
    ...
    Public Shared Function GetNewFolderStats(strFolderPath As String) As udtFolderStatsType
    ...
    Private Sub LogErrors(strSource As String, strMessage As String, ex As Exception)
    ...
    Protected Sub LogFileIntegrityError(strFilePath As String, strErrorMessage As String)

        RaiseEvent FileIntegrityFailure(strFilePath, strErrorMessage)
    End Sub

    Public Function MD5CalcFile(strPath As String) As String
        ' Calculates the MD5 hash of a given file
        ' Code from Tim Hastings, at http://www.nonhostile.com/page000017.asp

        Dim objReader As Stream
        Dim objMD5 As New Security.Cryptography.MD5CryptoServiceProvider
        Dim arrHash() As Byte

        ' open file (as read-only)
        objReader = New FileStream(strPath, FileMode.Open, FileAccess.Read)
    ...
    Public Function Sha1CalcFile(strPath As String) As String
    ...
    ''' <remarks></remarks>
    Protected Sub ValidateRequiredTextFound(
       strFilePath As String,
       strItemDescription As String,
       blnCheckRequiredTextThisFile As Boolean,
       blnNeedToCheckRequiredText As Boolean,
      ByRef strRequiredText() As String,
      ByRef blnRequiredTextFound() As Boolean,
       intRequiredTextMinMatchCount As Integer,
